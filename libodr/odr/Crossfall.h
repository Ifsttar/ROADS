...
//! \file Crossfall.h
//! \brief odr::Crossfall class declaration

#ifndef _ODR_CROSSFALL_H_
#define _ODR_CROSSFALL_H_
...
namespace odr
{
  ...
  //! Store crossfall information for a section of a road.
  ...
  public:
    ...
    { if(p) static_cast<Crossfall*>(p)->destroy(); }
    ...
    //! Return the length along the S-coordinate for which the crossfall
    ...
    //! Length of every crossfall record in road is re-computed accordingly.
...
#endif  // #ifndef _ODR_CROSSFALL_H_
